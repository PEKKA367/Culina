...
export class BiPriorityQueue {
    ...
    _pickNode(mode) {
        ...
        if (mode === 'oldest') {
            ...
            return this._findExtremum(true);
        } else if (mode === 'lowest') {
            return this._findExtremum(false);
        } else {
            return null;
        }
    }
    ...
    _findExtremum(wantHighest) {
        ...
        while (currentNode !== null) {
            ...
            if (wantHighest === true) {
                if (currentNode.priority > best.priority) {
                    isBetter = true;
                }
            } else {
                if (currentNode.priority < best.priority) {
            ...
            if (currentNode.priority === best.priority && currentNode.seq < best.seq) {
                isTie = true;
            }

            if (isBetter === true || isTie === true) {
                best = currentNode;
            }
