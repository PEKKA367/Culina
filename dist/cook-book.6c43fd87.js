...
})({"24cUF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "abd246ba6c43fd87";
"use strict";
...
},{}],"kaeuR":[function(require,module,exports,__globalThis) {
//IMPORTS
var _firebaseConfigJs = require("./firebase-config.js");
...
async function deleteRecipe(id, deleteButtonElement) {
    try {
        await (0, _firestore.deleteDoc)((0, _firestore.doc)((0, _firebaseConfigJs.db), "recipes", id));
...
function createRecipeCard(firebaseDoc) {
    ...
    ui.count.textContent = `\u{406}\u{43D}\u{433}\u{440}\u{435}\u{434}\u{456}\u{454}\u{43D}\u{442}\u{456}\u{432}: ${count}`;
    // Формуємо посилання
    ui.link.href = `pages/recipe.html?id=${recipeId}`;
    // Вішаємо подію видалення
    ui.btnDelete.addEventListener("click", async ()=>{
        if (confirm(`\u{412}\u{438}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{438} \u{440}\u{435}\u{446}\u{435}\u{43F}\u{442} "${data.title}"?`)) {
...
async function loadRecipes() {
    try {
        ...
        const querySnapshot = await (0, _firestore.getDocs)((0, _firestore.collection)((0, _firebaseConfigJs.db), "recipes"));
        // Перевірка на порожню базу
        if (querySnapshot.empty) {
            // Використовуємо OOCSS класи для тексту
            recipesContainer.innerHTML = `
                <div style="grid-column: 1 / -1; text-align: center;">
                    <p class="card-desc">\u{420}\u{435}\u{446}\u{435}\u{43F}\u{442}\u{456}\u{432} \u{43F}\u{43E}\u{43A}\u{438} \u{43D}\u{435}\u{43C}\u{430}\u{454}. \u{414}\u{43E}\u{434}\u{430}\u{439}\u{442}\u{435} \u{43F}\u{435}\u{440}\u{448}\u{438}\u{439}!</p>
                </div>
            `;
            return;
        }
...
},{"./firebase-config.js":"aGPmD","firebase/firestore":"3RBs1"}]},["24cUF","kaeuR"], "kaeuR", "parcelRequire9215", {})

//# sourceMappingURL=cook-book.6c43fd87.js.map
